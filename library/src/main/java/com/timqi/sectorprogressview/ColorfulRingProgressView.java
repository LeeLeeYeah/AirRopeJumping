...
public class ColorfulRingProgressView extends View {
    ...
    private float mPercent = (float)0.1;
    private float mStrokeWidth;
    private int mBgColor = 0xff86C1B5;//0xffe1e1e1;
    private float mStartAngle = 0;
    private int mFgColorStart = 0xff86C1B5;//0xffffe400;
    private int mFgColorEnd = 0xff86C1B5;//0xffff4800;
    ...
    public ColorfulRingProgressView(Context context, AttributeSet attrs) {
        ...
        try {
            mBgColor = a.getColor(R.styleable.ColorfulRingProgressView_bgColor, 0xff86C1B5);
            mFgColorEnd = a.getColor(R.styleable.ColorfulRingProgressView_fgColorEnd, 0xff86C1B5);

            mFgColorStart = a.getColor(R.styleable.ColorfulRingProgressView_fgColorStart, 0xff86C1B5);
